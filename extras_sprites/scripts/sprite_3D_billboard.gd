...
var texture_detail_normal:Texture:
	set(value):
		texture_detail_normal = value
		mesh.material.set_shader_parameter("texture_detail_normal",value)
...
func setup_shader():
	...
	var normal_shader = data.texture_normal if data.texture_normal else null
	...
	if material:
		...
		material.set_shader_parameter("texture_detail_normal",data.texture_detail_normal)
